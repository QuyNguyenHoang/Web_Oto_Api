    ...
    public partial class Db1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderStatisticId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StatisticDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TotalRevenue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalOrders = table.Column<int>(type: "int", nullable: false),
                    TotalProductsSold = table.Column<int>(type: "int", nullable: false),
                    TotalPaidOrders = table.Column<int>(type: "int", nullable: false),
                    TotalUnpaidOrders = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderStatistics", x => x.OrderStatisticId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PageVisitStatisticId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StatisticDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TotalVisits = table.Column<int>(type: "int", nullable: true),
                    UniqueVisits = table.Column<int>(type: "int", nullable: true),
                    CampaignVisits = table.Column<int>(type: "int", nullable: true),
                    StatisticType = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageVisitStatistics", x => x.PageVisitStatisticId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SalesByCategoryStatistics",
                columns: table => new
                {
                    SalesByCategoryStatisticId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    CategoryName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalRevenue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TotalProductsSold = table.Column<int>(type: "int", nullable: true),
                    StatisticDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StatisticType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesByCategoryStatistics", x => x.SalesByCategoryStatisticId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalNewCustomers = table.Column<int>(type: "int", nullable: true),
                    TotalReturningCustomers = table.Column<int>(type: "int", nullable: true),
                    StatisticType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductReviews_Users_Id",
                        column: x => x.Id,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoicesDetail", x => x.InvoiceDetailId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionHistory_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionHistory_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "PaymentMethodId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionHistory_Users_Id",
                        column: x => x.Id,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_PaymentMethodId",
                table: "TransactionHistory",
